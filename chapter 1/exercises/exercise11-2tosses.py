#
# Chapter 1 - Exercise 11 - Modified HTSimulation - 2 tosses
# Author: Michael Kwak
...
# 
# winnings is a list structure to track Peter's winnings per turn in a 2 roll game
...
output_file = open('/home/pi/py3prog/probability/chapter 1/output/exercise11-2tosses-output.txt', 'w')
...
for play in range (0, plays):
	...
	#
	# calculate Peter's j through a 2 roll game
	#
	...
	for roll in range (0, tosses):
		...
		#
		# after the 2 roll for-loop concludes, the final value
